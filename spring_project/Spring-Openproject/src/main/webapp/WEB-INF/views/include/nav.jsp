...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark" aria-label="Main navigation">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">오픈프로젝트</a>
    ...
    <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <c:if test="${loginInfo eq null}">
          ...
          <a class="nav-link" href="<c:url value="/member/logout"/>">LOGIN</a>
          </c:if>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<c:url value="/mypage/mypage1"/>">마이페이지1</a>
        </li>
             <li class="nav-item">
          <a class="nav-link" href="<c:url value="/mypage/mypage2"/>">마이페이지2</a>
        </li>
             <li class="nav-item">
          <a class="nav-link" href="<c:url value="/mypage/mypage3"/>">마이페이지3</a>
        </li>
        
                <li class="nav-item">
          <a class="nav-link" href="<c:url value="/member/list"/>">리스트</a>
        </li>
