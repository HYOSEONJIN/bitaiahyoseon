...
public class RestApiController {
	...
	/*
	 * @GetMapping("/{idx}") // RequestMapping(method=GET)과 같음,
	 * /rest/ver01/members/36와 같은 경로로 들어옴 // @GetMapping public String getRest(
	 * 
	 * @PathVariable("idx") int idx ) { return "@RestController를 사용한 응답처리 : " + idx;
	 * }
	 */
	@Autowired
	...
	@GetMapping("/{idx}")
	public Member getMemberInfo(@PathVariable("idx") int idx) {
