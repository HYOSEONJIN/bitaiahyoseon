...
//        document.querySelector('#uname+div.msg').style.display = 'block';
        document.getElementById('uname+div.msg').style.display = 'block';
        chk = true;
    }

    if (bd.value.trim().length < 1) {
        document.getElementById('bd+div.msg').style.display = 'block';
        chk = true;
    }

    if (pnum.value.trim().length < 1) {
        document.getElementById('pnum+.msg').style.display = 'block';
        chk = true;
    }

    if (pw.value.trim().length < 1 ) {
        document.getElementById('pw+div.msg').style.display = 'block';
        chk = true;
    }
    
    if (repw.value.trim().length < 1 ) {
        document.getElementById('pwchk+div.msg').style.display = 'block';
        chk = true;
    }
